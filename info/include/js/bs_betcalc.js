...
function func_calc_rc_num_of_bet(betline, betType) {
    ...
    switch (betType.toUpperCase()) {
        case "WIN":
            return func_calc_WIN_bet(betline);
        case "PLA":
            return func_calc_WIN_bet(betline);
        case "W-P":
            return func_calc_WIN_bet(betline) * 2;
        case "QIN":
            return func_calc_QIN_bet(betline);
        case "QPL":
            return func_calc_QIN_bet(betline);
        case "QQP":
            return func_calc_QIN_bet(betline) * 2;
        case "TRI":
            return func_calc_TRI_bet(betline);
        case "F-F":
            return func_calc_F_F_bet(betline);
        case "DBL":
            return func_calc_MultiLegWIN_bet(betType, betline);
        case "FCT":
            return func_calc_FCT_bet(betline);
        case "TCE":
            return func_calc_TCE_bet(betline);
        case "D-T":
            return func_calc_MultiLegTRI_bet(betType, betline);
        case "T-T":
            return func_calc_MultiLegT_T_bet(betType, betline);
        case "TBL":
            return func_calc_MultiLegWIN_bet(betType, betline);
        case "6UP":
            return func_calc_MultiLegWIN_bet(betType, betline);
        case "JKC":
            return func_calc_hb_fixed_odds_num_of_bet(betType, betline);
        case "TNC":
            return func_calc_hb_fixed_odds_num_of_bet(betType, betline);
        case "QTT":
            return func_calc_QTT_bet(betline);
        case "CWA":
            return func_calc_WIN_bet(betline);
        case "CWB":
            return func_calc_WIN_bet(betline);
        case "CWC":
            return func_calc_WIN_bet(betline);
        case "IWN":
            return 1; // not allowed multiple selection
    }
